...
export const SHARED_ICONS = [
  ...
  'star', 'rocket', 'trophy', 'moon', 'bed',
  'musical-notes', 'code-slash', 'briefcase', 'person', 'home',
  'journal', 'nutrition', 'walk', 'camera', 'globe',
  'school', 'airplane', 'cafe', 'game-controller', 'brush',
  'bicycle', 'medkit', 'bulb', 'phone-portrait', 'cart',
];
