...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    exportDataSub: 'Share a JSON backup of all your data',
    importData: 'Import / Restore',
    importDataSub: 'Paste a backup JSON to restore data',
    clearAllData: 'Clear All Data',
    clearAllDataSub: 'Delete all tasks, habits, goals and journal entries',
    exportSuccess: 'Data shared successfully',
    exportSuccessWeb: 'Backup copied to clipboard',
    importSuccess: 'Data restored. Please restart the app.',
  ...
  ar: {
    ...
    exportDataSub: 'مشاركة نسخة احتياطية بصيغة JSON',
    importData: 'استيراد / استعادة',
    importDataSub: 'الصق JSON للاستعادة',
    clearAllData: 'مسح جميع البيانات',
    clearAllDataSub: 'حذف جميع المهام والعادات والأهداف والمذكرات',
    exportSuccess: 'تمت مشاركة البيانات بنجاح',
    exportSuccessWeb: 'تم نسخ النسخة الاحتياطية',
    importSuccess: 'تمت الاستعادة. يرجى إعادة تشغيل التطبيق.',
