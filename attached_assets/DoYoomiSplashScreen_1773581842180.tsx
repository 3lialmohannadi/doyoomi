/**
 * DoYoomi – SplashScreen (React Native / Expo)
 *
 * المتطلبات / Requirements:
 *   expo install expo-linear-gradient
 *
 * الملفات المطلوبة / Required assets (ضعها في مجلد assets):
 *   assets/app-icon.png   ← أيقونة التطبيق
 *   assets/yoomi-ar.png   ← شعار "يومي" العربي
 *
 * طريقة الاستخدام / Usage:
 *   ضع هذا الكومبوننت كأول شاشة في التطبيق، وبعد انتهاء مدة
 *   الـ splash انتقل للشاشة الرئيسية عبر onFinish.
 *
...
interface Props {
  onFinish?: () => void;
  duration?: number; // مدة عرض الشاشة بالمللي ثانية (افتراضي 3000)
}
...
export default function SplashScreen({ onFinish, duration = 3000 }: Props) {
  ...
  useEffect(() => {
    ...
    // 4. Floating icon — looping up/down
    Animated.loop(
      Animated.sequence([
    ...
    <View style={styles.container}>
      ...
      <Animated.View style={[
        ...
        <Animated.View style={{
          ...
          <Image
            source={require("./assets/yoomi-ar.png")}
            style={styles.arLogo}
            resizeMode="contain"
          />
        </Animated.View>
